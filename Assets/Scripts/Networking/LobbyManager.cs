    ...
    public class LobbyManager : MonoBehaviour
    {
        ...
        async Task PeriodicUpdateLobby()
        {
            ...
            catch (LobbyServiceException e) when (e.Reason == LobbyExceptionReason.LobbyNotFound)
            {
                ...
                Debug.Log("Lobby has been disbanded.");
        ...
        public async Task<Lobby> CreateLobby(string lobbyName, int maxPlayers, string hostName, string relayJoinCode)
        {
            try
            {
                isHost = true;
        ...
        public async Task<Lobby> QuickJoinLobby(string playerName)
        {
            try
            {
                ...
                Debug.Log("Will start searching for lobby.");
                activeLobby = await LobbyService.Instance.QuickJoinLobbyAsync(options);
                if (this == null) return default;
